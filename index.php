...
<head>
    ...
    <section id="hero-slider-two" data-scroll-index="0">
        <div class="owl-carousel owl-theme">
            ...
            <div class="item">
                <div class="slide slide-1 col-xs-7" style="background-image: url(images/bgf1.jpg);">
            ...
            <div class="item">
                <div class="slide slide-2 col-xs-12" style="background-image: url(images/bgf2.jpg);">
                    <div class="slide-content  hero-inner h-100">

                        <h1 class="hero-title">
                            We build Canals to enhance sustainability of life
                        </h1>
                        <p class="hero-subtitle">
                            Canals
                        </p>
            ...
            <div class="item">
                <div class="slide slide-3 col-xs-12" style="background-image: url(images/bgf3.jpg);">
                    <div class="slide-content  hero-inner h-100">

                        <h1 class="hero-title">
                            Delivering Superlative
                        </h1>
                        <p class="hero-subtitle">
                            Infrastructure
                        </p>
            ...
            <div class="item">
                <div class="slide slide-4 col-xs-12" style="background-image: url(images/bgf4.jpg);">
                    <div class="slide-content  hero-inner h-100">
            ...
            <div class="item">
                <div class="slide slide-5 col-xs-12" style="background-image: url(images/bgf5.png);">
                    <div class="slide-content  hero-inner h-100">

                        <h1 class="hero-title">
                            We do water treatment activities
                        </h1>
                        <p class="hero-subtitle">
                            Water Treatment
                        </p>
  ...
  display: none;">
            ...
            <div class="row">
                        ...
                        <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                ...
                                <div class="carousel-item">
                                    <img class="d-block w-100" src="images/bgs2.jpg" alt="Second slide">
                                </div>
                                <div class="carousel-item">
                                    <img class="d-block w-100" src="images/bgs3.jpg" alt="Third slide">
                                </div>
                            </div>
                ...
                <div class="col-lg-6 about-inner" data-aos="fade-left" data-aos-delay="500" data-aos-duration="3000">
                    <div class="about-text">
                        ...
                        <p>
                            Aiming to carve out a place in the infrastructure sector, GDPL is dedicated to providing
                            top-notch and on-time project execution. The company pursues excellence via empowerment,
                            integrity, innovation, and agility. By 2025, GDPL wants to be among the top 10
                    ...
                    <ul>
                        <li>
                            ...
                            <div class="text">
                                ...
                                <p class="umvtext">
                                    Being dedicated to carving out a place in the infrastructure sector and pursuing
                                    excellence through empowerment, integrity, innovation, and agility with a passion
                                    for delivering high-quality and on-time project execution, GDPL will rank among the
                        ...
                        <li>
                            ...
                            <div class="text">
                                ...
                                <p class="umvtext">
                                    creating a global presence for UMSL in the engineering, procurement, and
    ...
    <section>
        <div class="container mt">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="umstextmv">Our Guiding Principles</h1>

                    <div class="wrapper">
                        <div class="center-line">
                            <!-- <a href="#" class="scroll-icon"><i class="fas fa-caret-up"></i></a> -->
                        </div>
                        <div class="row row-1 " data-aos="fade-right" data-aos-delay="100" data-aos-duration="3000"
                            style="animation-name: none;">
                            <section>
                                <i class="icon fas fa-hand-rock"></i>
                                <div class="details toltxip">
                                    <span class="title moderndtext">Empowerment
                                    </span>
                                    <p class="toptiptxtds">
                                        Encouraging employees to take initiative and give the best. Adopting an
                                        error-embracing environment to empower employees to lead and make decisions
                                    </p>
                                </div>
                            </section>
                        </div>
                        <div class="row row-2" data-aos="fade-left" data-aos-delay="100" data-aos-duration="3000"
                            style="animation-name: none;">
                            <section>

                                <div class="icon">
                                    <img src="images/agile.png" alt="" class="guidesafimgarea">
                                </div>
                                <div class="details toltxip">
                                    <span class="title moderndtext">Agility</span>
                                    <p class="toptiptxtds">
                                        Having a sense of urgency and ensuring before time execution
                                    </p>
                                </div>
                            </section>
                        </div>
                        <div class="row row-1" data-aos="fade-right" data-aos-delay="500" data-aos-duration="3000"
                            style="animation-name: none;">
                            <section>
                                <i class="icon fas fa-cog"></i>
                                <div class="details toltxip">
                                    <span class="title moderndtext">Integrity</span>
                                    <p class="toptiptxtds">
                        ...
                        <div class="row row-2" data-aos="fade-left" data-aos-delay="500" data-aos-duration="3000"
                            style="animation-name: none;">
                            <section>
                                <i class="icon fas fa-user-shield"></i>
                                <div class="details toltxip">
                                    <span class="title moderndtext">Quality</span>
                                    <p class="toptiptxtds">
                                        Making this a habit in whatever we do
                                    </p>
                                </div>
                            </section>
                        </div>
                        <div class="row row-1" data-aos="fade-right" data-aos-delay="500" data-aos-duration="3000"
                            ...
                            <section>
                                ...
                                <div class="details toltxip">
                                    <span class="title moderndtext">Learning</span>
                                    <p class="toptiptxtds">
                                        Adopting a culture of learning and un-learning- readjusting the course depending
                                        on
                        ...
                        <div class="row row-2" data-aos="fade-left" data-aos-delay="500" data-aos-duration="3000"
                            ...
                            <section>
                                ...
                                <div class="icon">
                                    <img src="images/safety.png" alt="" class="guidesafimgarea">
                                </div>
                                <div class="details toltxip">
                                    <span class="title moderndtext">Safety</span>
                                    <p class="toptiptxtds">
                                        Ensuring the health and safety of employees and going beyond the legal
                                        requirements
                        ...
                        <div class="row row-1" data-aos="fade-right" data-aos-delay="500" data-aos-duration="3000"
                            ...
                            <section>
                                ...
                                <div class="details toltxip">
                                    <span class="title moderndtext">Innovation</span>
                                    <p class="toptiptxtds">
                                        Pursuing new creative ideas that have the potential to change things
                                    </p>
                                </div>
                            </section>
                        </div>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="500" data-aos-duration="3000">
                    <div class="services-item">
                        ...
                        <div class="body">
                            <h6>Road</h6>
                            <p class="exoiptext">
                                Creating high quality road infrastructure is one of the prime operations of GDPL.
                            </p>
                ...
                <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="500" data-aos-duration="3000">
                    <div class="services-item">
                        <div class="icon">
                            <span>
                                <i class="fas fa-building serviceicondexign"></i>
                            </span>
                        </div>
                        <div class="body">
                            <h6>Building</h6>
                            <p class="exoiptext">
                                Company portfolio consists of a wide range of residential, institutional and industrial
                                buildings.
                            </p>
                            <a href="infrastructure#section2">Click For More <i class="fa fa-arrow-right"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="500" data-aos-duration="3000">
                    <div class="services-item">
                        <div class="icon">
                            <span>
                                <i class="fas fa-leaf serviceicondexign"></i>
                            </span>
                        </div>
                        <div class="body">
                            <h6>Irrigation</h6>
                            <p class="exoiptext">
                                With extensive experience, GDPL has constructed number of barrages, canal system,
                                drainage system.
                            </p>
                            <a href="infrastructure#section3">Click For More <i class="fa fa-arrow-right"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="500" data-aos-duration="3000">
                    <div class="services-item">
                        <div class="icon">
                            <span>
                                <i class="fas fa-water serviceicondexign"></i>
                            </span>
                        </div>
                        <div class="body">
                            <h6>Water Projects</h6>
                            <p class="exoiptext">
                                With extensive experience, GDPL has constructed number of barrages, canal system,
                                drainage systems.
                            </p>
                            <a href="infrastructure#section4">Click For More <i class="fa fa-arrow-right"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="500" data-aos-duration="3000">
                    <div class="services-item">
                        <div class="icon">
                            <span>
                                <i class="fas fa-subway serviceicondexign"></i>
                            </span>
                        </div>
                        <div class="body">
                            <h6>Railways</h6>
                            <p class="exoiptext">
                                GDPL has forayed into railways sector constructing new BG lines under East Cost
                                Railways.
                            </p>
                            <a href="infrastructure#section5">Click For More <i class="fa fa-arrow-right"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="500" data-aos-duration="3000">
                    <div class="services-item">
                        <div class="icon">
                            <span>
                                <i class="fas fa-truck serviceicondexign"></i>
                            </span>
                        </div>
                        <div class="body">
                            <h6>Logistics</h6>
                            <p class="exoiptext">
                                Our dedicated Logistic division provides that vital link between our various projects
                                for shifting.
                            </p>
                            <a href="https://devanthosting.com/GDPL/logistics">Click For More <i
